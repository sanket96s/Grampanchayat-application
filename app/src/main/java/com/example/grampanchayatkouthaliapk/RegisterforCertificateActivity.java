...
public class RegisterforCertificateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (documentType != null) {
            documentTypeTextView.setText(getString(R.string.document_type_label_1, documentType));
        } else {
            String fallbackDocumentType = getString(R.string.please_select_document);
            documentTypeTextView.setText(getString(R.string.document_type_label_1, fallbackDocumentType));
        ...
        Button uploadAadharButton = findViewById(R.id.upload_aadhar_button);
        Button uploadRationCardButton = findViewById(R.id.upload_ration_card_button);
